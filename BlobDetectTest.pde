...
void setup() {
  ...
  if (!context.isInit()) {
    ...
    // mirror to be more intuitive
    context.setMirror(true);    

    blobs = createImage(kinectWidth, kinectHeight, RGB);
...
void draw() {
  ...
  userImage = context.rgbImage();
  image(userImage, 0, 0);
  blobs.copy(userImage, 0, 0, userImage.width, userImage.height, 
    0, 0, blobs.width, blobs.height);
